...
_DOC_ALLOWLIST: set[str] = {
    ...
    "SHAPBeeswarmVisualizer", "SHAPBarVisualizer", "SHAPWaterfallVisualizer",
    ...
    "residuals_chart", "prediction_error_chart", "cooks_distance_chart",
    ...
    "classification_report_chart", "class_balance_chart",
    ...
    "intercluster_distance_chart", "silhouette_chart", "manifold_chart", "elbow_chart",
