...
# ///
"""yellowbrick confusion matrix panel."""
...
W = int(os.environ.get("FERRUM_AUDIT_W", "500"))
...
def main(out_dir: Path) -> None:
    ...
    viz = ConfusionMatrix(model, ax=ax); viz.fit(Xtr, ytr); viz.score(Xte, yte); viz.finalize()
