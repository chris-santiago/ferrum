...
# ///
"""yellowbrick feature-importance panel."""
...
def main(out_dir: Path) -> None:
    ...
    # Defaults only: no labels= override. Mirrors ferrum's call site exactly so
    # any "feature names missing" finding applies equally to both libraries.
