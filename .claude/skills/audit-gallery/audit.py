...
REPO_ROOT = SKILL_DIR.parent.parent.parent  # .claude/skills/audit-gallery/ → repo root
PLOTS_DIR = SKILL_DIR / "plots"
OUTPUT_DIR = REPO_ROOT / ".claude" / "output" / "audit-gallery"
...
Generated by `.claude/skills/audit-gallery/audit.py`.
