...
# ]
# ///
"""scikit-plot ROC panel — isolated PEP 723 env. scikit-plot is unmaintained;
pinning sklearn<1.5 mirrors yellowbrick to stay safe."""
...
def main(out_dir: Path) -> None:
    ...
    skplt.metrics.plot_roc(yte, probas, ax=ax)
    fig.savefig(out_dir / "skp.png", dpi=DPI)
    plt.close(fig)
