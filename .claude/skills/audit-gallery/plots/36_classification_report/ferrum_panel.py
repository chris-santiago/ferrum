"""Ferrum classification-report panel."""
...
def main(out_dir: Path) -> None:
    ...
    model = LogisticRegression(max_iter=500, random_state=SEED).fit(Xtr, ytr)
    viz = ferrum.ClassificationReportVisualizer(model).fit(Xte, yte)
